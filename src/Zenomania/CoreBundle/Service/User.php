...
class User extends UserAwareService
{
    ...
    /**
     * Получить Query для пагинации с возможностью поиска
     * по строке вида "имя", "фамилия", "имя фамилия", "фамилия имя"
     *
     * @param string|null $query
     * @return Query
     */
    public function getPaginationQuery($query = null)
    {
        $repo = $this->getEntityManager()->getRepository(EntityUser::class);
        return $repo->getQueryByName($query);
    }
    ...
    /**
     * Найти пользователя по коду восстановления (verifyEmailUuid)
     * @param $code
     * @return null|EntityUser
     */
