 ...
 */
class Version20171107122848 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE order_cart (id SERIAL NOT NULL, order_id INT NOT NULL, product_id INT NOT NULL, quantity INT NOT NULL, price NUMERIC(10, 2) NOT NULL, total_price NUMERIC(10, 2) NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT \'now()\' NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_4652B2A08D9F6D38 ON order_cart (order_id)');
        ...
        $this->addSql('CREATE TABLE order_status_history (id SERIAL NOT NULL, created_by INT NOT NULL, order_id INT NOT NULL, from_order_status_id INT NOT NULL, to_order_status_id INT NOT NULL, note VARCHAR(512) DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
