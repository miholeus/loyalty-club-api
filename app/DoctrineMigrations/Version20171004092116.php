...
class Version20171004092116 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE promo_coupon ADD activated_by INT NOT NULL');
        $this->addSql('ALTER TABLE promo_coupon ALTER created_by SET NOT NULL');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE promo_coupon ALTER created_by DROP NOT NULL');
    }
}
