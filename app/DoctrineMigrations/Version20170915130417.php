...
class Version20170915130417 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE device_token (id SERIAL NOT NULL, user_id INT DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, created_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, updated_on TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, device_type VARCHAR(255) DEFAULT NULL, device_name VARCHAR(255) DEFAULT NULL, status INT DEFAULT NULL, PRIMARY KEY(id))');
